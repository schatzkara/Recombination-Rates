...
from data_formatting import combine_SNP_sim_data
from data_formatting import combine_ID_sim_data
from data_formatting import combine_model_ID_data
# import csv
# import os 
# import glob
# import numpy as np
...
# phi = 1/2
# iterations = 1000
path1 = 'C:/Users/Owner/Documents/UNCG REU/Project/Recombination-Rates/Data/SNP Sim/Averages'
path2 = 'C:/Users/Owner/Documents/UNCG REU/Project/Recombination-Rates/Data/ID Sim/Averages'
path3 = 'C:/Users/Owner/Documents/UNCG REU/Project/Recombination-Rates/Data/Model CM vs ID'

combine_SNP_sim_data(L, generations, path1)
combine_ID_sim_data(L, generations, path2)
combine_model_ID_data(L, generations, path3)
...
# 		for x in range(g):
# 			values2[x] = []
# 		with open(('all_averages_for_SNP_sim_' + str(l) + '_' + str(g) + '.csv'), 'w', newline = '') as f:
# 			writer = csv.writer(f)
