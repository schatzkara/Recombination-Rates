...
exponential.model <- lm(log(dfrset0k1$`Mutations on Each Strain`)~dfrset0k1$`Average CMs`)
linear.model <- lm(dfrset0k1$`Average CMs`~dfrset0k1$`Mutations on Each Strain`)
...
ggsave("models_cms_v_muts.png",device="png")
